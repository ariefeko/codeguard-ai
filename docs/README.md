...
The root [README](../README.md) is the short project entry point. Use these documents for implementation and operations details:
...
- [Progress](../PROGRESS.md) — current delivery status and next priorities.

The legacy `Documentation/` directory contains historical exports, design assets, and snapshots. It is not the canonical source for current behavior.
